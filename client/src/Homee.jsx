...
export default function Homee() {
  return (
    <div className="h-screen" style={{ backgroundColor: "#2d2d2d" }}>
      <p className="absolute  font-bold text-sm mt-20  w-[450px] ml-4 lg:w-[800px] lg:ml-96"  style={{ color: "#eef4f6" }}>
      ...
      <p className="absolute  font-bold text-sm mt-40  w-[450px] ml-4 lg:w-[800px] lg:ml-96" style={{ color: "#eef4f6" }}>
      ...
      <p className="absolute  font-bold text-sm mt-72  w-[450px] ml-4 lg:w-[800px] lg:ml-96" style={{ color: "#eef4f6" }}>
